...
y_valid = df['Preempt-Decision-PosExp']

filename='12NB-NN-EVP-PosExp-0.8.model'
...
with open(f'2022-08-06_Preempt_12NB_cutoff-{cutoff}_continuous-posExp-validation-output.csv', "w", newline="") as f:
    writer = csv.writer(f)
